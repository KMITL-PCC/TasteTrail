...
*/
-- AlterTable
ALTER TABLE "public"."Restaurant" ADD COLUMN     "max_price" DECIMAL(5,2) NOT NULL,
ADD COLUMN     "min_price" DECIMAL(5,2) NOT NULL,
ALTER COLUMN "description" SET NOT NULL,
ALTER COLUMN "address" DROP NOT NULL,
ALTER COLUMN "latitude" DROP NOT NULL,
ALTER COLUMN "longitude" DROP NOT NULL,
ALTER COLUMN "status" SET DEFAULT 'Temporarily_Closed';
